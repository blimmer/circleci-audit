...
export class WorkflowService {
   ...
   * @throws ApiError
   */
  public static getWorkflowById(id: string): CancelablePromise<{
    /**
   ...
   * @throws ApiError
   */
  public static cancelWorkflow(id: string): CancelablePromise<{
    message?: string;
  }> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static listWorkflowJobs(id: string): CancelablePromise<{
    items: Array<{
      /**

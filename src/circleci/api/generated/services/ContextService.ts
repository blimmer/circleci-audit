...
export class ContextService {
   ...
   * @throws ApiError
   */
  public static createContext(requestBody?: {
    /**
   ...
   * @throws ApiError
   */
  public static getContext(contextId: string): CancelablePromise<{
    /**
     * The unique ID of the context.
     */
    id: string;
   ...
   * @throws ApiError
   */
  public static deleteContext(contextId: string): CancelablePromise<{
    /**

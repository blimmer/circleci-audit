...
export type ListContextsResponse = Awaited<ReturnType<typeof ContextService.listContexts>>;
...
>;
export type EnvironmentVariable = ListEnvironmentVariablesFromContextResponse["items"][0];
